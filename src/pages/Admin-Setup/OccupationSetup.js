...
export default function Occupation() {
  ...
  const getOccupationSetup = () => {
    setshow(true)
    GET("/api/Setup/GetAllOccupationSetup")
      .then(setups => {
  ...
  const upsertOccupationSetup = () => {
    if (!!isEdit) {
      ...
      UPDATE(`/api/Setup/UpdateOccupationSetup`, body)
        .then(res => {
          if (res.status == 200) {
      ...
      CREATE("/api/Setup/CreateOccupationSetup", body)
        .then(res => {
          if (res.status == 200) {
            openNotificationWithIcon(
              "success",
  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumb */}
          <Breadcrumbs title="Admin" breadcrumbItem="Occupation Setup" />
          <BackDrop open={show} />
          <Row>
            <Col md="2"></Col>
            <Col lg="10">
        ...
        >
          <DialogTitle id="max-width-dialog-title">Occupation Setup</DialogTitle>
          <DialogContent>
            <DialogContentText>
              <Form>
                <Row form>
