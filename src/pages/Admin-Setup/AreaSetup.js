...
export default function AreaSetup() {
  ...
  const upsertAreaSetup = () => {
    if (!!isEdit) {
      ...
      UPDATE(`/api/Setup/UpdateAreaSetup`, body)
        .then(res => {
          if (res.status == 200) {
      ...
      CREATE("/api/Setup/CreateAreaSetup", body)
        .then(res => {
          if (res.status == 200) {
            openNotificationWithIcon(
              "success",
  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumb */}
          <Breadcrumbs title="Admin" breadcrumbItem="Area Setup" />
          <BackDrop open={show} />
          <Row>
            <Col md="2"></Col>
            <Col lg="10">
            ...
            <DialogContentText>
              <Form>
                <Row form>
                  ...
                  <Col md={6}>
                    <FormGroup>
                      <Label for="exampleEmail">Area Setup</Label>
                      <Input
                        type="text"
                        value={Name}
