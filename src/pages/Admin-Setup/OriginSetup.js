...
export default function OriginSetup() {
  ...
  const upsertCitySetup = () => {
    if (!!isEdit) {
      ...
      UPDATE(`/api/Setup/UpdateCitySetup`, body)
        .then(res => {
          if (res.status == 200) {
      ...
      CREATE("/api/Setup/CreateCitySetup", body)
        .then(res => {
          if (res.status == 200) {
            openNotificationWithIcon(
              "success",
  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumb */}
          <Breadcrumbs title="Admin" breadcrumbItem="Origin Setup" />
          <BackDrop open={show} />
          <Row>
            <Col md="2"></Col>
            <Col lg="10">
            ...
            <DialogContentText>
              <Form>
                <Row form>
                  ...
                  <Col md={6}>
                    <FormGroup>
                      <Label for="exampleEmail">Origin Setup</Label>
                      <Input
                        type="text"
                        value={Name}
                        placeholder="Origin Setup"
