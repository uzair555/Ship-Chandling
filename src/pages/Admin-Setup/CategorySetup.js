...
export default function CategorySetup() {
  ...
  const getCategorySetup = () => {
    setshow(true)
    GET("/api/Setup/GetAllCategorySetup")
      .then(setups => {
  ...
  const upsertCategorySetup = () => {
    if (!!isEdit) {
      ...
      UPDATE(`/api/Setup/UpdateCategorySetup`, body)
        .then(res => {
          if (res.status == 200) {
      ...
      CREATE("/api/Setup/CreateCategorySetup", body)
        .then(res => {
          if (res.status == 200) {
            openNotificationWithIcon(
              "success",
  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumb */}
          <Breadcrumbs title="Admin" breadcrumbItem="Category Setup" />
          <BackDrop open={show} />
          <Row>
            <Col md="2"></Col>
            <Col lg="10">
            ...
            <DialogContentText>
              <Form>
                <Row form>
                  ...
                  <Col md={6}>
                    <FormGroup>
                      <Label for="exampleEmail">Category Setup</Label>
                      <Input
                        type="text"
                        value={Name}
                        placeholder="Category Setup"
